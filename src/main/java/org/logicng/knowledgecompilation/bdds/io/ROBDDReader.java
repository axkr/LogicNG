...
public class ROBDDReader {
   ...
   */
  private ROBDDReader(int[] robddArray, int numNodes, FormulaFactory factory) {
   ...
   * </p>
   * <b>Format Specification</b> The input list is a flattened array encoding a Reduced Ordered
   * BDD (ROBDD) with complemented edges.
   * <ul>
